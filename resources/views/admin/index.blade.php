...
<div class="profile-info mt-4">
    ...
    <span>Welcome to our airline's dashboard. Here, you can manage flights, passengers, user accounts, and more.
        Thanks for your hard work in making our airline the best it can be!</span>
</div>
                                ...
                                <tbody>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{ asset('assets/admin') }}/images/avatar/1.jpg"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td> #5469 </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{ asset('assets/admin') }}/images/avatar/2.jpg"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td> #5468 </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{ asset('assets/admin') }}/images/avatar/3.jpg"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td> #5467 </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="avatar">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{ asset('assets/admin') }}/images/avatar/4.jpg"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td> #5466 </td>
                                    ...
                                    <tr class=" pb-0">
                                        ...
                                        <td class="avatar pb-0">
                                            <div class="round-img">
                                                <a href="#"><img class="rounded-circle"
                                                        src="{{ asset('assets/admin') }}/images/avatar/6.jpg"
                                                        alt=""></a>
                                            </div>
                                        </td>
                                        <td> #5465 </td>
                            ...
                            <ul>
                                <li>
                                    <div class="msg-received msg-container">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/admin') }}/images/avatar/64-1.jpg" alt="">
                                ...
                                <li>
                                    <div class="msg-sent msg-container">
                                        <div class="avatar">
                                            <img src="{{ asset('assets/admin') }}/images/avatar/64-2.jpg" alt="">
                                            <div class="send-time">11.11 am</div>
                                        </div>
                                        <div class="msg-box">
                                            <div class="inner-box">
